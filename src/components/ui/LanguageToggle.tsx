...
export const LanguageToggle: React.FC<LanguageToggleProps> = ({ pageProps }) => {
    const { slug, altSlug, locale, altLocale } = pageProps
    ...
    return (
        <Menu >  
            ...
            <MenuList width="fit-content"  p="0rem" >
                {   
